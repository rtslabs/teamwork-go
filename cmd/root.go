...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.teamworkgo.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".teamworkgo" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".teamworkgo")
	}
